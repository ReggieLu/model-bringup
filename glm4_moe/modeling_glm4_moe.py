...
from sambanova_modelzoo.patch_router import sn_patch_replace, sn_patch_post_process_self
...
class Glm4MoeAttention(nn.Module):
    ...
    def __init__(self, config: SNGlm4MoeConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class Glm4MoeTopkRouter(nn.Module):
    @sn_patch_post_process_self(modification = Glm4MoeTopkRouterPatch.patch__init__)
...
class Glm4MoePreTrainedModel(PreTrainedModel):
    ...
    @sn_patch_replace(patch = Glm4MoePreTrainedModelPatch.patch_init_weight_)
...
class Glm4MoeRotaryEmbedding(nn.Module):
    def __init__(self, config: SNGlm4MoeConfig, device=None):
        super().__init__()
...
@auto_docstring
class SNGlm4MoeModel(Glm4MoePreTrainedModel):
...
@auto_docstring
class SNGlm4MoeForCausalLM(Glm4MoePreTrainedModel, CausalLMGenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.model = SNGlm4MoeModel(config)
        self.vocab_size = config.vocab_size
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, SNGlm4MoeForCausalLM

        >>> model = SNGlm4MoeForCausalLM.from_pretrained("meta-glm4_moe/Glm4Moe-2-7b-hf")
...
__all__ = ["Glm4MoePreTrainedModel", "SNGlm4MoeModel", "SNGlm4MoeForCausalLM"]
